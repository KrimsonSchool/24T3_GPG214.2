...
namespace Gamekit3D.GameCommands
{
    ...
    {
        //The hl_type of Command to send. This is not link to any UnityEvent and just act as a way to differentiate this command from other in GameCommandHandlers
        [Tooltip("The hl_type of command to send.")]
